...
export function buildDeviceTelemetryInspectScript(inventorySample) {
...
export function buildSafeSelectOnlineDeviceScript(targetDeviceId) {
...
export async function inspectDeviceTelemetryOnPage(page, inventoryIds) {
...
export async function safelySelectOnlineDeviceOnPage(page, targetDeviceId) {
