...
import { runPositionsTreeSync, PositionsTreeSyncError, POSITIONS_TREE_SYNC_SUMMARY_FILE, buildPositionsTreeSyncSummary, } from "./positions-tree-sync.js";
...
export async function main() {
    ...
    try {
        ...
        writeFileSync(failurePath, JSON.stringify(buildPositionsTreeSyncSummary({
            status: "failed",
            mode,
            inventoryCount: 0,
