...
import { finishSyncRun, markAccountReauth, startSyncRun, } from "../db/repositories.js";
...
function resolveMode() {
    ...
    if (arg === "dry" || arg === "sync" || arg === "reconcile")
        return arg;
    throw new Error("Usage: inventory-sync-cli.ts <dry|sync|reconcile>");
}
async function recordReauthFailure(config, message) {
    try {
