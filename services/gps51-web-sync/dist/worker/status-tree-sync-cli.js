...
import { runStatusTreeSync, StatusTreeSyncError, STATUS_TREE_SYNC_SUMMARY_FILE, buildTreeSyncSummary, } from "./status-tree-sync.js";
...
export async function main() {
    ...
    try {
        ...
        writeFileSync(failurePath, JSON.stringify(buildTreeSyncSummary({
            status: "failed",
            mode,
            portalCounts: null,
            reconciliation: null,
